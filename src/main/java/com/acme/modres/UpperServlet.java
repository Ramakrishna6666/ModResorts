...
// Replaced WebSphere-specific com.ibm.websphere.servlet.response.ResponseUtils with standard Java HTML encoding (blocker-2, blocker-7)
...
public class UpperServlet extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    // for container-native deployment on AWS ECS/EKS (blocker-2, blocker-7)
