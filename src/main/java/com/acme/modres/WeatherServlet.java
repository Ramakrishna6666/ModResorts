...
public class WeatherServlet extends HttpServlet {
  ...
  /**
   * Returns server environment information using standard Java APIs.
   * Previously used IBM WebSphere-specific com.ibm.websphere.runtime.ServerName
   * which is not available in standard Java 21 environments.
   */
  private String configureEnvDiscovery() {
    String serverEnv = "";
    // Use standard Java system properties instead of IBM WebSphere-specific API
    serverEnv += System.getProperty("server.name", "unknown-server");
    serverEnv += "@" + System.getProperty("server.host", "localhost");
    return serverEnv;
  }
