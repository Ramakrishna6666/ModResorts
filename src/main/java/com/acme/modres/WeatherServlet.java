...
public class WeatherServlet extends HttpServlet {
  ...
  private static final String WEATHER_API_KEY_SECRET_NAME = System.getenv().getOrDefault("WEATHER_API_KEY_SECRET_NAME", "modresorts/weather-api-key");
  ...
  private String getSecretFromSecretsManager(String secretName) {
    try (SecretsManagerClient secretsClient = SecretsManagerClient.builder()
      ...
      logger.warning("Secret " + secretName + " not found or is empty");
      return null;
