...
public class WeatherServlet extends HttpServlet {
  ...
  /**
   * Replaced WebSphere-specific ServerName API with environment variable configuration
  ...
  /**
   * Replaced WebSphere-specific JNDI/RMI configuration with standard properties
   * for container-friendly deployment. Use REST/gRPC for inter-service communication.
   */
  private Properties getServiceProperties() {
    Properties props = new Properties();
    
    // Replace WebSphere-specific JNDI factory with environment-based configuration
    String namingFactory = System.getenv("NAMING_FACTORY_INITIAL");
    String providerUrl = System.getenv("NAMING_PROVIDER_URL");
