...
public class WeatherServlet extends HttpServlet {
  ...
  /**
   * Removed WebSphere-specific server discovery.
   * This method would need to be replaced with application server-agnostic discovery
   * or configuration-based approach.
   */
  private String configureEnvDiscovery() {
    String serverEnv = "";
    
    // Replace WebSphere-specific APIs with standard Java system properties
  ...
  private InitialContext setInitialContextProps() {
    // Fix raw type warning by using generics
    Hashtable<String, String> ht = new Hashtable<>();

    // Note: WebSphere-specific JNDI factory replaced with generic approach
    // This will need to be configured based on the target application server
    ht.put("java.naming.factory.initial", "org.apache.naming.java.javaURLContextFactory");
    ht.put("java.naming.provider.url", "localhost:2809");
