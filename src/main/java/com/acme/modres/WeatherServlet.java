...
public class WeatherServlet extends HttpServlet {
  ...
  private static final String WEATHER_API_SECRET_NAME = System.getenv().getOrDefault("WEATHER_API_SECRET_NAME", "modresorts/weather-api-key");
  ...
  private String getWeatherApiKeyFromSecretsManager() {
    ...
    try {
      ...
      // Parse JSON secret to extract the API key
      JsonObject jsonObject = JsonParser.parseString(secret).getAsJsonObject();
      String apiKey = jsonObject.get("WEATHER_API_KEY").getAsString();
