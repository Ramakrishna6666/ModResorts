...
class SecondFilterTest {
    ...
    @Test
    void testDoFilter_withContent() throws IOException, ServletException {
    ...
    @Test
    void testDoFilter_callsChain() throws IOException, ServletException {
        BufferedReader reader = new BufferedReader(new StringReader("Test"));
        when(request.getReader()).thenReturn(reader);
    ...
    @Test
    void testDoFilter_writesOutput() throws IOException, ServletException {
